...
RUN echo "50" && npm install github:georgysavva/mineflayer
RUN echo "49" && npm install github:daohanlu/mineflayer-pathfinder
RUN echo "49" && npm install github:georgysavva/prismarine-viewer-colalab
