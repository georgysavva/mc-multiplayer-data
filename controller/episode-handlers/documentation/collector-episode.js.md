...
const taskSpec = { type: "directional", direction: getRandomDirection(), distance: 7 };
...
coordinator.sendToOtherBot(`done_${cycle}`, bot.entity.position.clone(), episodeNum, "leader_done");
