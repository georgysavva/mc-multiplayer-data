...
# sudo python3 orchestrate.py start --build --logs-dir ${BASE_DIR}/logs --keep-running --start-delay-seconds 10
...
python3 orchestrate.py postprocess --workers 16 --comparison-video --output-dir "${BASE_DIR}/aligned" --data-dir "${BASE_DIR}"